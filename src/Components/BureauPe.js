          ...
          <div className="content-pole-expert">
            {
              <Row>
                <Col md={'6'} className="address-col">
                  ...
                  <span>
                    {bureauItem.codePostal} {bureauItem.localite}
                  </span>
                </Col>
                <Col md={'6'} className="contact-col">
                  {bureauItem.tel != null && (
                    <span>
                      <i className="icon_phone default-color"></i>{' '}
                      {bureauItem.tel}
                    </span>
                  )}
                  {bureauItem.fax != null && (
                    <span>
                      <i className="icon_printer default-color"></i>{' '}
                      {bureauItem.fax}
                    </span>
                  )}
                  {bureauItem.mail != null && (
                    <span>
                      <i className="icon_mail default-color"></i>{' '}
                      {bureauItem.mail}
                    </span>
                  )}
                </Col>
